const generateLanguageList = (languages) => {
    const totalSize = Object.values(languages).reduce((acc, lang) => acc + lang.size, 0);
  
    // Generate the HTML for the horizontal bar
    ...
    let html = `<div style="background-color: #2d2d2d; color: white; font-family: Arial, sans-serif; padding: 20px; width: 430px; margin: auto;">
                  <h2 style="color: #ffffff; text-align: center;">Most Used Languages</h2>
